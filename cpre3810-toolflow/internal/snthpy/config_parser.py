...
CONFIG = namedtuple("CONFIG", "modelsim quartus license rars_tok tf_tok rars_id tf_id rars_path")
...
def read_config(config="Lab"):
    ...
    ret = CONFIG(modelsim, quartus, license, rars_tok, tf_tok, rars_id, tf_id, rars_path)
